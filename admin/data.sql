CREATE TABLE categoria(
    id_categorias INT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
    nome_categorias VARCHAR(100) NOT NULL
);


CREATE TABLE produtos(
    id_produtos INT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
    nome_produtos VARCHAR(100) NOT NULL,
    sku VARCHAR(100) NOT NULL,
    categoria_id_produtos INT UNSIGNED,
    preco DECIMAL(10,2) NOT NULL,
    estoque INT,
    descricao TEXT,
    capa VARCHAR(500),
    FOREIGN KEY (categoria_id_produtos) REFERENCES categoria(id_categorias)
);
...
('Fio cabo pp 3x1,5mm²', 'CPP-315-001', 2, 35.15, 150, 'Cabo PP com 3 vias interna de 1,5mm². Altamente flexível e com dupla isolação, recomendado para extensões, ferramentas elétricas e eletrodomésticos.', 'https://cdn.awsli.com.br/2500x2500/2059/2059267/produto/347714445/bcd00f3d36e83157c2babc2edd68497f-4ksu9sss4y.jpg'),
('Fio cabo PP 3x2,5mm', 'CPP-325-001', 2, 39.69, 174, 'Cabo PP industrial com 3 vias de 2,5mm². Excelente resistência mecânica e flexibilidade, ideal para extensões pesadas e equipamentos móveis.', 'https://encrypted-tbn0.gstatic.com/shopping?q=tbn:ANd9GcRsk-HMRZrlIztKhcLXRKTk1mLq4qYR_fkt45ieqQLyhufxOX8KAZlQfHay1jdX4WmfTkb4Lf5gc7UqGP4qCxsCQKDgDORX7pL38OUx7KobK_Fu8XMxfg6D2XuvqfAeJXOXlZQVoyYBvLg&usqp=CAc'),
...
CREATE TABLE historico_estoque (
    ...
    acao ENUM('Entrada', 'Saída', 'Ajuste') NOT NULL,
